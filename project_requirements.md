...
### 8.1 聯盟行銷（Affiliate）— Phase 1+

| 平台 | 佣金 | 實作方式 |
|------|:--:|------|
| Amazon Associates | 1-3% | 購買連結加 `?tag=your-tag-20` |
| Humble Bundle | 5-10% | Partner program |
| Green Man Gaming | 2-5% | Affiliate network |

**原則**：購買連結本身就是服務，聯盟行銷只是加追蹤碼，**不影響使用者體驗**。

### 8.2 Google AdSense — Phase 4+

| 規則 | 說明 |
|------|------|
| 位置 | 僅側邊欄底部 + 文章底部 |
| 禁止 | 不插在遊戲卡片之間、不彈出、不自動播放 |
| 數量 | 每頁最多 2 個廣告單元 |
